...
document.write("<table width="+width+" height="+height+" cellpadding=1 cellspacing=0 \
		style=\"font-family: arial, verdana; color: "+font1+"; font-size: 12px;\" bgcolor="+bgcolor1+" border=1>\
			<tr bgcolor="+heading+" align=center><td colspan=7>\
				...
				<tr align=center><td><a style=\"cursor: pointer;\" onclick=\"return prev()\">&#206;napoi</a></td>\
				...
				<td><a style=\"cursor: pointer;\" onclick=\"return next()\">&#206;nainte</a></td></tr></table>\
			</td></tr>\
			<tr bgcolor="+bgcolor2+" align=center><td>Duminic&#259;</td><td>Luni</td><td>Mar&#355;i</td><td>Miercuri</td><td>Joi</td><td>Vineri</td><td>S&#226;mb&#259;t&#259;</td></tr>");
...
for(var xx=0; xx<6; xx++)
{
	...
	for(var cc=0; cc<7; cc++){
		var dd = xx*7+cc;
		if(dd == 41)
			document.write("<td align=center><a style=\"font-size: 9px; color: 888888; text-decoration: none;\"</a></td>");
		else
